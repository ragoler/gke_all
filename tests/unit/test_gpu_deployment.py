...
def test_vllm_deployment_architecture():
    ...
    expected_image = "us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:latest"
    ...
    assert model_id_var["value"] == "gs://vertex-model-garden-public-us/codegemma/codegemma-7b-it", f"Expected MODEL_ID value gs://vertex-model-garden-public-us/codegemma/codegemma-7b-it, got {model_id_var['value']}"
